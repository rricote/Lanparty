                ...
                <div class="col-xs-12">
                    ...
                    @if(isset($id))
                        ...
                        <div class="col-xs-12">
                            ...
                            {!! Form::open(array('url' => 'admin/rols/editar/' . $id)) !!}

                            <div class="col-xs-12">

                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                    <div class="form-group">
                                        {!! Form::label('rols', 'Nom de la rols:', null, array('class' => 'control-label')) !!}
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="icon-edit"></i></span>
                                            {!! Form::text('name', $rols->name, array('required', 'class' => 'form-control', 'placeholder' => 'Nom')) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="table-header">
                            Llistat de totes les rols
                        </div>

                        <div class="table-responsive">
                            <table id="taula-rols" class="table table-striped table-bordered table-hover">
                                <thead>
                                <tr>
                                    <th class="center">
                                        <label>
                                            ...
                                            <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                <div class="inline position-relative">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-only-icon dropdown-yellow pull-right dropdown-caret dropdown-close">
                                                        ...
                                                        <li>
                                                            <a id="{{ $r->id }}" class="tooltip-error borrar" data-rel="tooltip" title="Delete">
                                                                <span class="red">
                    ...
                    <div class="col-xs-12">
                        ...
                        {!! Form::open(array('url' => 'admin/rols/afegir')) !!}
